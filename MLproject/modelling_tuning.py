...
def run_tuning(
    ...
    with mlflow.start_run(run_name=run_name) as run:
        ...
        # -- Simpan model ke file pkl dulu --
        model_pkl_path = "random_forest_corn_yield.pkl"
        joblib.dump(best_model, model_pkl_path)
        logger.info(f"Model disimpan ke: {model_pkl_path}")

        # -- Log model ke MLflow artifacts (manual) --
        ...
        # -- Log pkl sebagai artefak tambahan --
